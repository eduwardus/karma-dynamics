# -*- coding: utf-8 -*-
"""
Created on Sun Jun 15 18:07:17 2025
...
# -*- coding: utf-8 -*-
"""
Simulación Kármica con Resonancia para Inducción de Caos (Versión Corregida)
"""
...
def approximate_entropy(U, m=2, r=0.2, sample_size=200):
    ...
    # Muestreo aleatorio para eficiencia - CORRECCIÓN APLICADA AQUÍ
...
try:
    for sim in tqdm(range(start_sim, n_sim), initial=start_sim, total=n_sim, 
        ...
        if sim % 10 == 0:
            ...
            # Guardar trayectoria si se detecta caos potencial
            if max_lyap > 0.2:
                np.save(f"chaotic_trajectory_sim_{sim}.npy", full_trajectory)
                print(f"¡Trayectoria caótica detectada! Guardada en chaotic_trajectory_sim_{sim}.npy")
